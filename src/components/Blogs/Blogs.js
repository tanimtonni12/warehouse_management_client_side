    ...
    return (
        <div className='container'>
            <div className='text-center my-5'>
                <h4 className='text-secondary fw-bold'>Blogs</h4>
            </div>
            <div className='shadow p-3 my-5 text-align'>
                <h4 className='text-danger mb-3'>Difference between javascript and node js?</h4>
            ...
            <div className='shadow p-3 my-5 text-align'>
                <h4 className='text-danger mb-3'>Differences between sql and nosql databases?</h4>
                <p>
            ...
            <div className='shadow p-3 my-5 text-align'>
                <h4 className='text-danger mb-3'>What is the purpose of jwt and how does it work?</h4>
